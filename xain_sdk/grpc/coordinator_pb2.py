...
# source: xain_sdk/grpc/coordinator.proto
...
RendezvousRequest = _reflection.GeneratedProtocolMessageType('RendezvousRequest', (_message.Message,), {
  ...
  '__module__' : 'xain_sdk.grpc.coordinator_pb2'
